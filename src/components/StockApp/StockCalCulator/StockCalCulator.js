...
function StockCalCulator({stockNum, handleAdd, handleSub}){
  ...
  const handleCalculateStock = (e) => {
    setCurrentStock(currentStock + e.target.value)
  }
  ...
  return (
    <section>
      ...
      <p>You have {currentStock} stock</p>
    </section>
  )
}
